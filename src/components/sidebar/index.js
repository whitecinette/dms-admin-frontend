...
function Sidebar({ isCollapsed, open, toggleSidebar }) {
  ...
  const navItems = [
    ...
    // { name: "HR", to: "/hrDashboard", icon: <svg width="20" height="20" viewBox="0 0 60 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M58.1773 49.2858H50.8928V53.5714H58.1773C59.184 53.5714 60 52.7554 60 51.7487V51.1084C60 50.1019 59.184 49.2858 58.1773 49.2858Z"
            fill="currentColor"
          />
          <path
            d="M0 51.1084V51.7487C0 52.7554 0.816094 53.5714 1.82273 53.5714H35.8929V49.2858H1.82273C0.816094 49.2858 0 50.1019 0 51.1084Z"
            fill="currentColor"
          />
          <path
            d="M44.0342 42.8571H42.7515C40.7383 42.8571 39.1072 44.4893 39.1072 46.5014V56.3556C39.1072 58.3677 40.7383 59.9999 42.7515 59.9999H44.0342C46.0473 59.9999 47.6785 58.3677 47.6785 56.3556V46.5014C47.6785 44.4893 46.0473 42.8571 44.0342 42.8571Z"
            fill="currentColor"
          />
          <path
            d="M58.1773 27.855H25.0928V32.1408H58.1774C59.184 32.1408 60.0001 31.3247 60.0001 30.3182V29.6779C60 28.6712 59.1839 27.855 58.1773 27.855Z"
            fill="currentColor"
          />
          <path
            d="M1.82273 32.1408H10.0928V27.855H1.82273C0.816094 27.855 0 28.6712 0 29.6777V30.3181C0 31.3246 0.816094 32.1408 1.82273 32.1408Z"
            fill="currentColor"
          />
          <path
            d="M16.9514 21.4265C14.9384 21.4265 13.3071 23.0588 13.3071 25.0707V34.925C13.3071 36.9372 14.9384 38.5693 16.9514 38.5693H18.2342C20.2473 38.5693 21.8785 36.9372 21.8785 34.925V25.0707C21.8785 23.0588 20.2472 21.4265 18.2342 21.4265H16.9514Z"
            fill="currentColor"
          />
          <path
            d="M1.82273 10.7142H27.7629V6.42856H1.82273C0.816094 6.42856 0 7.24465 0 8.25129V8.89161C0 9.89813 0.816094 10.7142 1.82273 10.7142Z"
            fill="currentColor"
          />
          <path
            d="M58.1772 6.42856H42.7629V10.7142H58.1773C59.184 10.7142 60 9.89813 60 8.89149V8.25118C59.9999 7.24465 59.1838 6.42856 58.1772 6.42856Z"
            fill="currentColor"
          />
          <path
            d="M34.6216 17.1429H35.9043C37.9174 17.1429 39.5486 15.5107 39.5486 13.4986V3.6443C39.5486 1.63219 37.9174 0 35.9043 0H34.6216C32.6084 0 30.9773 1.63219 30.9773 3.6443V13.4985C30.9772 15.5107 32.6084 17.1429 34.6216 17.1429Z"
            fill="currentColor"
          />
        </svg>
      ),
                  ...
                  {item.to !== "#" ? (
                    ...
                    >
                      {cloneElement(item.icon, {
                        style: { color: "rgba(249, 64, 8, 0.62)" },
                      })}
                    ...
                    >
                      ...
                      {!isCollapsed && (
                        <span style={{ color: "rgb(85, 26, 139)" }}>
                          {item.name}
                        </span>
                      )}
                      {!isCollapsed && (
