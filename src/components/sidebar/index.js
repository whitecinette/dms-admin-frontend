...
function Sidebar({ isCollapsed, open, toggleSidebar }) {
  ...
  const navItems = [
    ...
    { name: "HR", to: "#", icon: <svg width="20" height="20" viewBox="0 0 60 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: "Configuration", to: "#", icon: <svg width="20" height="20" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
